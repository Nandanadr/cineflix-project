...
class Movie(BaseClass):
    ...
    # thumbnail = models.ImageField(upload_to='movies/tumbnails')

    description = models.TextField()

    release_date = models.DateField()

    industry = models.ForeignKey('Industry',on_delete=models.CASCADE)  # SE_NULL return null value CASCADE means delete all things
